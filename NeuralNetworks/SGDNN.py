...
def main():
    ...
    for width in widthList:
        ...
        W1 = [
            [random.normal() for i in range(width - 1)] for j in range(len(data[0]) - 1)
        ]
        W2 = [[random.normal() for i in range(width - 1)] for j in range(width)]
        W3 = [random.normal() for i in range(width)]
